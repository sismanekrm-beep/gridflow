...
export default function AppShell() {
  ...
  const logoSection = (
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '16px 20px', borderBottom: `1px solid ${BORDER}`, flexShrink: 0 }}>
      <div style={{ width: '32px', height: '32px', borderRadius: '8px', backgroundColor: PRIMARY, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
        <Tag size={15} color="white" />
      </div>
      <div>
        <div style={{ fontSize: '14px', fontWeight: 700, color: '#0F172A', lineHeight: 1.2, fontFamily: "'Space Grotesk', 'Inter', sans-serif" }}>GridLabel</div>
        <div style={{ fontSize: '10px', color: MUTED }}>TANEX TW-2024</div>
      </div>
    </div>
  );

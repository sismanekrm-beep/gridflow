  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F0F7FF', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: "'Inter','Arial',sans-serif" }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        {/* Logo */}
        <div style={{ backgroundColor: '#fff', borderRadius: '16px', padding: '8px 32px', boxShadow: '0 4px 24px rgba(11,79,138,0.08)', border: '1px solid #E2E8F0', textAlign: 'center', marginBottom: '12px' }}>
